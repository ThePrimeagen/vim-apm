...
config :vim_apm, VimApmWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "NZ3Fxylzll85A/19vhOL4vq5DmVyYKcP9gSbBg/rAaj7HDzhfbsfBo/SONWw18aE",
  watchers: [
...
config :vim_apm, VimApmWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/vim_apm_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :vim_apm, dev_routes: true
